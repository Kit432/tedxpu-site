...
export default function Header() {
  ...
  return (
    <header
      className="site-header fixed inset-x-0 top-0 z-[9999] bg-white/90 backdrop-blur px-5 sm:px-8 lg:px-9"
      data-nosnippet
    >
      <div className="header-inner flex items-start justify-between gap-6">
        <a href="#hero" className="block shrink-0" aria-label="TEDxPanteion University home">
          <Image
